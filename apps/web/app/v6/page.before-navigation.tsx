...
export default function SLAV6() {
  return (
    <main className="slaV6">
      ...
      {/* SLA REWARDS */}
      <section id="rewards" className="rewardsSection">

        <div className="rewardsInner">

          <div className="rewardsCopy">
            <span className="rewardsKicker">SLA REWARDS</span>

            <h2>Every journey counts.</h2>

            <p>
              Earn points when you fly with SLA and use them across flights,
              upgrades and selected travel services.
            </p>

            <div className="rewardsActions">
              <a href="/rewards" className="rewardsPrimary">
                Join SLA Rewards
              </a>

              <a href="/rewards" className="rewardsSecondary">
                Sign in
              </a>
            </div>
          </div>
          ...
          <div className="rewardsCard">
            ...
            <div className="rewardsCardTop">
              <span className="rewardsInfinity">∞</span>
            ...
            <div className="rewardsBalance">
              ...
              <strong>Travel further</strong>

              <p>
                Flights · Upgrades · Priority services · Partner rewards
              </p>
            </div>

            <div className="rewardsCardBottom">
        ...
        <div className="rewardsBenefits">
          ...
          <article>
            <span>01</span>
            <h3>Earn</h3>
            <p>Collect points whenever you fly with SLA.</p>
          </article>

          <article>
            <span>02</span>
            <h3>Use</h3>
            <p>Redeem points against flights and eligible services.</p>
          </article>

          <article>
            <span>03</span>
            <h3>Progress</h3>
            <p>Unlock additional recognition as you travel more.</p>
          </article>

          <article>
            <span>04</span>
            <h3>Enjoy</h3>
            <p>Access selected travel and airport benefits.</p>
          </article>
